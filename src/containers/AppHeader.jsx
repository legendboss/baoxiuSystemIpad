...
const AppHeader = props => {
    let { menuClick, avatar, userName, menuToggle, modifyPassword, loginOut, unReadCount, goToNewsList } = props
    const menu = (
        <Menu>
    ...
    return (
        <Header className='header'>
            ...
            <div className='right'>
                <div className='mr15'>
                    <Badge dot={unReadCount > 0 ? true : false} offset={[-2, 0]}>
                        <BellOutlined onClick={goToNewsList} />
                    </Badge>
                </div>
                <div>
